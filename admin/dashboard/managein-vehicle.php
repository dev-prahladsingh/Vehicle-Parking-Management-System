...
echo "<script>window.location.href='managein-vehicle.php'</script>";
          }
...
?>
                ...
                <tr>
                  ...
                  <td><a href="vmanagein.php?viewid=<?php echo $row['ID'];?>" class="button">View</a> 
<a href="managein-vehicle.php?del=<?php echo $row['ID'];?>" class="button button2" onClick="return confirm('Are you sure you want to delete?')">Delete</a>
                  </td>
                </tr>
                <?php 
$cnt=$cnt+1;
